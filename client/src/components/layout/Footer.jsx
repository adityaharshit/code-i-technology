...
const Footer = () => {
  return (
    <footer className="bg-gray-800 bg-opacity-90 backdrop-blur-md border-t border-gray-700 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Empowering students with cutting-edge technology education and hands-on learning experiences.
            </p>
...
export default Footer;client/src/