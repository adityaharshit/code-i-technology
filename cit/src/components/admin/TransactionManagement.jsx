  ...
  if (loading) {
    return (
      <div className="animate-fade-in-up">
        <div className="mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-white animate-fade-in-down">
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
              ...
              {transactions.map((transaction, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-6 animate-fade-in-left animate-delay-400">
                    <span
                      className={`inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium capitalize border ${getStatusColor(
                        transaction.status
                      )}`}
                    >
      ...
      <TransactionDetailModal
        key={selectedTransaction?.tid || "transaction-detail"}
